...
--
-- Table structure for table `student_discussion_forum`
--

DROP TABLE IF EXISTS `student_discussion_forum`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `student_discussion_forum` (
  `Std_Id` int NOT NULL,
  `Forum_Id` int NOT NULL,
  `IsAdmin` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`Std_Id`,`Forum_Id`),
  KEY `Forum_Id` (`Forum_Id`),
  CONSTRAINT `student_discussion_forum_ibfk_1` FOREIGN KEY (`Std_Id`) REFERENCES `student` (`Std_id`),
  CONSTRAINT `student_discussion_forum_ibfk_2` FOREIGN KEY (`Forum_Id`) REFERENCES `discussion_forums` (`Id`)
