...
--
-- Table structure for table `items_bought_from_sale`
--

DROP TABLE IF EXISTS `items_bought_from_sale`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `items_bought_from_sale` (
  `Id` int NOT NULL,
  ...
  PRIMARY KEY (`Id`),
  KEY `Std_Id` (`Std_Id`),
  CONSTRAINT `items_bought_from_sale_ibfk_1` FOREIGN KEY (`Std_Id`) REFERENCES `student` (`Std_id`),
  CONSTRAINT `items_bought_from_sale_ibfk_2` FOREIGN KEY (`Id`) REFERENCES `items_for_sale` (`Id`)
...
-- Dump completed on 2024-02-18 21:57:13
